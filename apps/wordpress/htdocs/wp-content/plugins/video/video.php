...
class VideoPress {
	...
	public function media_button() { ?>
		...
		<a href="https://public-api.wordpress.com/videopress-plugin.php?page=video-plugin&amp;video_plugin=1&amp;iframe&amp;TB_iframe=true" id="add_video" class="thickbox button" title="VideoPress"><span></span> <?php _e( 'Add Video', 'video' ); ?></a>
